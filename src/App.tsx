    ...
    <div className="App flex h-screen bg-gray-50 font-roboto">
      <div className="flex flex-col items-center w-16 h-full overflow-hidden text-gray-400 bg-gray-900">
        ...
        <div className="flex flex-col items-center mt-3 border-t border-gray-700">
          <Link label="home" onClick={setActiveLink} key="home" activeLink={activeLink}>
            <svg
          ...
          <Link label="search" onClick={setActiveLink} key="search" activeLink={activeLink}>
            <svg
              className="w-6 h-6 stroke-current"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <Link label="dashboard" onClick={setActiveLink} key="dashboard" activeLink={activeLink}>
            <svg
              className="w-6 h-6 stroke-current"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
